...
Por ser orientado à documentos JSON, podemos modelar dados de forma mais natural, de como os dados realmente serão utilizados em nossa aplicação, ao invés de criar várias ligações entre tabelas, o que o dá a característica de banco não-relacional.
