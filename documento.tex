...
Também foi criado uma aplicação (Figuras \ref{fig:ClientAppExample} e \ref{fig:ServerAppExample}) para mostrar na prática os conceitos aqui apresentados, e todo o código foi disponibilizado via GitHub, através do repositório\footnote{\url{https://github.com/rodrigocichetto/tcc}}, com todas as informações de licença e de como executar.
